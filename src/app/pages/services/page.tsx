...
import TimeCard from "@/components/service/TimeCard";
...
function ScheduleContent() {
  ...
  if (loading) {
    return (
      <div className="flex w-full h-[calc(100vh-80px)] p-3 justify-center">
        <div className="flex w-full h-full laptop:w-80 bg-[#191919] rounded-xl justify-center">
  ...
  return (
    <div className="flex flex-col laptop:flex-row justify-between laptop:items-start items-center laptop:justify-center laptop:mt-0 w-full h-[calc(100dvh-80px)] p-3 justify-center gap-4">
      <div className="flex flex-col laptop:flex-col laptop:items-center justify-between w-full h-full items-center max-w-96 laptop:w-fit bg-[#191919] rounded-xl p-4 text-white">
        <div>
          <Calendar
            mode="single"
            selected={date}
      ...
      <div className="flex flex-col w-full max-w-96 h-full min-h-[480px] laptop:w-96 bg-[#191919] rounded-xl p-4 mb-4">
        ...
        <div className="flex w-full flex-row justify-evenly items-center p-3 border rounded-xl">
          ...
          <span className="bg-[#143A4E] text-white font-bold drop-shadow p-3 rounded-lg">
            {params.price}
          </span>
        </div>
        ...
        <Button variant="outline-primary" className="p-3">SALVAR AGENDAMENTO</Button>
      </div>
    </div>
  );
}
